...
public class Assets {
    ...
    public static BufferedImage sand, grass, dirt, stoneWall, sandWall, water, tree, wood;
    ...
    public static void init(){
        ...
        SpriteSheet woodSheet = new SpriteSheet(ImageLoader.loadImage("/textures/wood120x120.png"));
